/** Inline SVG icons — no emoji (ui-ux-pro-max). PROTOTYPE only. */
...
export function IconList({ className, size = 22 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconArrowDownLeft({ className, size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
